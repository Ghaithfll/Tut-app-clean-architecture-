...
class AppSize {
  //          any value u need across the app, (corner radius,elevation,animation duration,animation speed,...), and u can create classes as u need one for each purpose (Single purpose principle SOLID)
